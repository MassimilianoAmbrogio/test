                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" class="form-control" name="number_flight_arrival" id="number_flight_arrival" placeholder="Number Flight Arrival" required>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" class="form-control" name="number_flight_departure" id="number_flight_departure" placeholder="Number Flight Departure" required>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" class="form-control" name="passport_number" id="passport_number" placeholder="Passport Number" required>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-check">
                            ...
                            <input type="radio" class="form-control" name="hotel_necessary" id="hotel_necessary" placeholder="Hotel Necessary" required>
                        </div>
                        <div class="col-md-6 form-check">
                            <label for="hotel_not_necessary" class="control-label">Hotel Not Necessary</label>
                            <input type="radio" class="form-control" name="hotel_not_necessary" id="hotel_not_necessary" placeholder="Hotel Not Necessary" required>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <textarea name="special_request" id="special_request" cols="30"></textarea>
                        </div>
                        <!-- Status -->
                        <div class="col-md-6 form-group">
