<form action="{{ route("room/update", ["room_id" => $room->id]) }}" method="POST">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Modifica Stanza</h4>
    </div>
    <!-- Name, Qty pre-imposted -->
    <div class="modal-body">
        <div class="row">
            <div class="col-md-6 form-group">
                <label for="name" class="control-label">Name</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{ $room->name }}" required>
            </div>
            <div class="col-md-6 form-group">
                <label for="qty" class="control-label">Qty</label>
                <input type="number" class="form-control" name="qty" id="qty" placeholder="Qty" value="{{ $room->qty }}" min="1" required>
            </div>
            <!-- Status pre-imposted -->
            <div class="col-md-6 form-group">
